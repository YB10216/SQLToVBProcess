...
Public Class SQLWithoutNoteFactory
    Implements IFactory(Of CodeText)

    Private sqlParaFactory As New InverseSQLParaWithoutNoteFactory()
    'Private sdFactory As New InverseSDFactory()
...
Public Class InverseSQLParaWithoutNoteFactory
...
Public Class InverseSDWithoutNoteFactory
    Implements IFactory(Of String)
